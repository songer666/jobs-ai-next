...
const styles = {
  ...
  backButton:
    "flex items-center gap-2 text-white/60 hover:text-white transition-colors",
  ...
  feedbackContent:
    "prose prose-invert max-w-none prose-headings:text-white prose-p:text-white/80 prose-strong:text-white prose-ul:text-white/80 prose-li:text-white/80",
        ...
        <main className={styles.main}>
          <div className="flex flex-col items-center justify-center py-16 text-center">
            ...
            <p className="text-white/60 max-w-md">
              AI 正在分析您的面试表现，这可能需要 1-2
              分钟。您可以返回列表页面，评分完成后会自动更新。
            </p>
            <button
              onClick={() => router.push("/dashboard/interview")}
