...
const styles = {
  ...
  card: {
    ...
    badge:
      "absolute -top-4 left-1/2 -translate-x-1/2 gradient-btn text-white text-xs sm:text-sm font-medium px-3 sm:px-4 py-1 rounded-full",
  },
  plan: {
  ...
  cta: {
    light:
      "w-full py-3 sm:py-4 rounded-full font-medium border-2 border-white/20 text-white hover:bg-white/10 text-sm sm:text-base",
      ...
      <div className={styles.grid}>
        ...
        <div className={`${styles.card.base} ${styles.card.default}`}>
          ...
          <div className="flex items-baseline gap-1">
            ...
            <span
              className={`${styles.plan.period} ${styles.plan.periodLight}`}
            >
          ...
          <ul className={styles.features.list}>
            {freeFeatures.map((feature, index) => (
              <li key={index} className={styles.features.item}>
                <svg
                  className={styles.features.iconLight}
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                  <path
        ...
        <div className={`${styles.card.base} ${styles.card.popular}`}>
          ...
          <ul className={styles.features.list}>
            {proFeatures.map((feature, index) => (
              <li key={index} className={styles.features.item}>
                <svg
                  className={styles.features.iconDark}
                  viewBox="0 0 20 20"
                  fill="currentColor"
                >
                  <path
          ...
          <Button className={styles.cta.dark}>升级到专业版</Button>
        </div>
