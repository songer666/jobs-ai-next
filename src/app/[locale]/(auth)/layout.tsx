...
const styles = {
  ...
  bgGradient: 'absolute inset-0 bg-gradient-to-br from-[#fd409a]/20 via-[#0b081a] to-[#f5a867]/20',
  bgRadial: 'absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[800px] h-[800px] bg-gradient-radial opacity-30',
  leftContent: 'relative z-10 flex flex-col justify-center items-center w-full p-12',
  ...
  featureIcon: 'w-8 h-8 rounded-full gradient-btn flex items-center justify-center text-sm',
          ...
          <div className={styles.mobileLogo.wrapper}>
            <div className={styles.mobileLogo.icon}>
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <path d="M8 15c1.5 2 6.5 2 8 0" stroke="#fff" strokeWidth="2" strokeLinecap="round"/>
              </svg>
            </div>
