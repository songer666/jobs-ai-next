...
const styles = {
  wrapper: 'min-h-screen bg-[#0b081a] flex flex-col items-center justify-center px-6',
  code: 'text-[120px] md:text-[180px] font-black text-white italic tracking-tight leading-none',
  title: 'text-2xl md:text-4xl font-bold text-white uppercase tracking-wider mt-4',
