...
export async function submitAnswer(
    ...
    const response = await fetch(getApiUrl(config.api.question.submit(questionId)), {
        method: "POST",
        headers: {
            "Content-Type": "application/json",
        },
...
export function getDifficultyColor(difficulty: QuestionDifficulty): "success" | "warning" | "danger" {
    const colors: Record<QuestionDifficulty, "success" | "warning" | "danger"> = {
        easy: "success",
        medium: "warning",
        hard: "danger",
    }
