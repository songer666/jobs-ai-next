...
import { useQuestions, useQuestionUsage, getDifficultyLabel } from '@/api/question';
...
export function QuestionHistorySidebar() {
    ...
    const { sidebarOpen, toggleSidebar, newQuestionId, clearNewQuestion } = useQuestionsLayout();
                    ...
                    <div className={styles.header}>
                        ...
                        {usage && usage.limit > 0 && (
                            <div className={styles.usage}>
                                ...
                                <span>
                                    {t('history.todayRemaining')} <span className={styles.usageCount}>{usage.remaining}/{usage.limit}</span>
                                </span>
                            </div>
                        )}
                    </div>
                                ...
                                return (
                                    ...
                                    >
                                        <div className={styles.itemHeader}>
                                            <span className={`${styles.itemDifficulty} ${difficultyStyleMap[question.difficulty]}`}>
