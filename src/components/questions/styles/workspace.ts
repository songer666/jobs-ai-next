export const workspaceStyles = {
  ...
  // 配置区域
  configSection:
    "flex-1 flex flex-col items-center justify-center max-w-xl mx-auto w-full",
  configCard:
    "w-full bg-white/5 border border-white/10 rounded-2xl p-6 space-y-5",
  ...
  streamingContent:
    "mt-6 w-full max-w-2xl bg-white/5 border border-white/10 rounded-xl p-4 prose prose-invert prose-sm max-w-none",
};
