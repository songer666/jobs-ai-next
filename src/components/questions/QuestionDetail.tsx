...
import { Send, Loader2, Star, Sparkles, Trash2, AlertCircle } from 'lucide-react';
import ReactMarkdown from 'react-markdown';
import remarkGfm from 'remark-gfm';
import { AlertDialog } from '@heroui/react';
import { CodeBlock } from '@/components/common/CodeBlock';
import { useQuestion, useDeleteQuestion, submitAnswer, type StreamEvent, getDifficultyLabel } from '@/api/question';
            ...
            <div className={styles.content}>
                <div className={styles.questionCard}>
                    <div className={styles.questionHeader}>
                        ...
                        <span className={`${styles.questionBadge} ${difficultyStyleMap[question.difficulty]}`}>
                ...
                {displayFeedback ? (
                    <div className={styles.resultGrid}>
                        <div className={styles.answerCard}>
                            <div className={styles.answerCardLabel}>{t('detail.yourAnswer')}</div>
                        ...
                        <AlertDialog.Dialog className="sm:max-w-[500px] bg-[#2a2a2a] border border-white/10">
                            ...
                            <div className="flex items-start gap-4 pb-4">
                                ...
                                <div className="flex-1">
                                    ...
                                    {t('detail.deleteConfirm.message', { name: question.jobInfo?.name || '此题目' })}
                                </p>
                                </div>
                            </div>
                            <div className="flex items-center justify-end gap-3 pt-6">
                                ...
                                >
                                    {deleteMutation.isPending ? t('detail.deleteConfirm.deleting') : t('detail.deleteConfirm.confirm')}
                                </button>
                            </div>
                        </AlertDialog.Dialog>
                    </AlertDialog.Container>
