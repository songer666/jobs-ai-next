...
const styles = {
    ...
    iconWrapper: 'flex-shrink-0 w-12 h-12 rounded-full bg-red-500/20 flex items-center justify-center',
    ...
    deleteButton: 'px-6 py-2.5 bg-red-500 hover:bg-red-600 text-white rounded-lg transition-colors font-medium',
};
                        ...
                        <div className={styles.header}>
                            ...
                            <div className={styles.headerContent}>
                                ...
                                <p className={styles.body}>
                                    {itemName ? (
                                        <>
                                            确定要永久删除 <span className={styles.highlight}>{itemName}</span> 及其所有数据吗？此操作无法撤销。
                                        </>
                                    ) : (
                                        <>确定要永久删除这个职位及其所有数据吗？此操作无法撤销。</>
                                    )}
                                </p>
                            </div>
                        </div>
