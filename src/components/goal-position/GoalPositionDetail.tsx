...
const styles = {
  ...
  editButton:
    "flex items-center gap-2 px-4 py-2.5 bg-[#1a1528] hover:bg-[#221a35] border border-white/10 rounded-lg text-white text-sm font-medium transition-colors",
  editIcon: "w-4 h-4",
  deleteButton:
    "flex items-center gap-2 px-4 py-2.5 bg-red-500/20 hover:bg-red-500/30 border border-red-500/30 rounded-lg text-red-400 text-sm font-medium transition-colors disabled:opacity-50 disabled:cursor-not-allowed",
  deleteIcon: "w-4 h-4",
      ...
      <div className={styles.header}>
        ...
        {canEdit && (
          <div className={styles.actions}>
            <Link
              href={`/dashboard/goal-position/${id}/edit`}
