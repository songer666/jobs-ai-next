...
import { Pencil, Trash2, Eye, Globe, Lock, Clock, Briefcase } from 'lucide-react';
...
const styles = {
    ...
    iconButton: 'p-2.5 rounded-lg border border-white/10 hover:bg-white/5 transition-colors',
...
export function GoalPositionCard({ position, onDelete, isDeleting }: GoalPositionCardProps) {
    ...
    return (
        <div className={styles.card}>
            ...
            <div className={styles.actions}>
                <Link href={`/dashboard/goal-position/${position.id}`} className={styles.viewButton}>
