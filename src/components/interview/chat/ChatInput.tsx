...
const styles = {
  controls:
    "fixed bottom-0 left-0 right-0 bg-[#0b081a] border-t border-white/10 p-4 md:p-6",
  controlsInner:
    "max-w-7xl mx-auto flex items-end justify-center gap-3 md:gap-4",
  textarea:
    "flex-1 px-4 py-3 bg-white/5 border border-white/10 rounded-lg text-white placeholder:text-white/40 resize-none text-sm md:text-base min-h-[48px] max-h-[200px] overflow-y-auto",
  micButton:
  ...
  micButtonInactive:
    "bg-gradient-to-r from-[#fd409a] to-[#f5a867] hover:scale-105",
