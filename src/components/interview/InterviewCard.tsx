...
const styles = {
  ...
  deleteButton:
    "p-2.5 rounded-lg border border-white/10 hover:bg-red-500/10 text-red-400 hover:text-red-300 transition-colors",
              ...
              <AlertDialog.Dialog className={styles.dialog}>
                ...
                <div className={styles.dialogHeader}>
                  ...
                  <div className={styles.dialogHeaderContent}>
                    <h2 className={styles.dialogHeading}>删除面试记录？</h2>
                    <p className={styles.dialogBody}>
                      确定要永久删除{" "}
                      <span className={styles.dialogHighlight}>
                        {interview.jobInfo?.name || "此面试"}
                      </span>{" "}
                      的面试记录吗？此操作无法撤销。
                    </p>
                  </div>
