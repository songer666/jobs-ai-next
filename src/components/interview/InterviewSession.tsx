...
import { useInterview, generateQuestion, submitAnswer, useCompleteInterview, getChatMessages, addChatMessage, type ConversationMessage, type GenerateQuestionResult } from '@/api/interview';
        ...
        return (
            <div className={styles.container}>
                <div className={styles.loading}>
                    ...
                    <p className={styles.loadingText}>{t('session.loading')}</p>
                </div>
            </div>
        );
    }
        ...
        <div className={styles.container}>
            {isCompleted ? (
                ...
                <div className="flex items-center justify-between px-6 py-4 border-b border-white/10">
                    ...
                    <h1 className="text-lg font-semibold text-white">{t('session.interviewRecord')}</h1>
                    <button
                    ...
                    <AlertDialog.Container>
                        <AlertDialog.Dialog className="sm:max-w-[420px] bg-[#1a1625] border border-white/10">
                            ...
                            <AlertDialog.Header>
                                ...
                                <AlertDialog.Heading>{t('session.endConfirm.title')}</AlertDialog.Heading>
                            </AlertDialog.Header>
                            <AlertDialog.Body>
                                {aiMessageCount < 10 ? (
                                    <p className="text-yellow-400">
                                        {t('session.endConfirm.warningMessage', { count: aiMessageCount })}
                                    </p>
                                ) : (
                                    <p>{t('session.endConfirm.normalMessage')}</p>
                                )}
                            </AlertDialog.Body>
                            <AlertDialog.Footer>
                                <Button
