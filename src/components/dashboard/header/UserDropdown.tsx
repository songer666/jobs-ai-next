...
const styles = {
    ...
    dropdown: {
        container: 'absolute right-0 top-full mt-2 w-48 rounded-xl bg-[#1a1528] border border-white/10 overflow-hidden z-50 shadow-xl',
        ...
        logout: 'flex items-center gap-3 px-4 py-2.5 text-red-400 hover:bg-red-500/10 hover:text-red-300 transition-colors text-sm w-full',
    },
};
