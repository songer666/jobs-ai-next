  ...
  return (
    <div className={authStyles.steps.wrapper}>
      <div
        ...
        role={
          (currentStep === "otp" || currentStep === "reset") && canGoBack
            ? "button"
            : undefined
        }
        tabIndex={
      ...
      />
      <div
        className={`${authStyles.steps.step} ${currentStep === "reset" ? authStyles.steps.active : currentStep === "success" ? authStyles.steps.completed : authStyles.steps.inactive}`}
      >
