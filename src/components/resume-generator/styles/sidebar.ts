export const sidebarStyles = {
    ...
    `,
    itemActive: 'bg-[#fd409a]/10 border-[#fd409a]/20 shadow-lg shadow-[#fd409a]/5',
    itemNew: 'animate-pulse bg-emerald-500/10 border-emerald-500/20',
    itemHeader: 'flex items-center justify-between mb-2',
    itemBadge: 'text-xs px-2.5 py-1 rounded-full font-medium bg-white/10 text-white/70 truncate max-w-[120px]',
