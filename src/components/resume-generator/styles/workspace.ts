export const workspaceStyles = {
    ...
    configPanel: 'w-full bg-white/5 border border-white/10 rounded-xl sm:rounded-2xl p-4 sm:p-6 space-y-4 sm:space-y-5',
    ...
    switchRow: 'flex items-center justify-between py-3 px-4 bg-white/5 border border-white/10 rounded-lg',
    switchLabel: 'text-white/80 text-sm font-medium',
    switchDesc: 'text-white/40 text-xs mt-1',
    
    // 对话区域
    chatContainer: 'flex-1 flex flex-col bg-[#1a1528] rounded-xl border border-white/10 overflow-hidden',
    ...
    chatInput: 'flex-1 bg-[#0d0a14] border border-white/10 rounded-lg px-3 sm:px-4 py-2 sm:py-3 text-sm sm:text-base text-white placeholder:text-white/40 focus:outline-none focus:ring-2 focus:ring-[#fd409a]/50',
    
    // 消息气泡
    messageBubble: 'max-w-[80%] p-3 rounded-lg',
    messageUser: 'bg-gradient-to-r from-[#fd409a] to-[#f5a867] text-white ml-auto',
    ...
    templateCard: 'bg-[#0d0a14] border border-white/10 rounded-xl p-4 cursor-pointer transition-all hover:border-[#fd409a]/50',
    templateCardSelected: 'bg-[#0d0a14] border-2 border-[#fd409a] rounded-xl p-4 cursor-pointer',
    ...
    resultContent: 'bg-[#0d0a14] rounded-lg p-4 font-mono text-sm text-white/80 whitespace-pre-wrap max-h-[400px] overflow-auto',
    
    // 按钮（使用主页渐变色 gradient-btn）
    primaryButton: 'bg-gradient-to-r from-[#fd409a] to-[#f5a867] text-white font-semibold rounded-lg sm:rounded-xl px-5 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base hover:opacity-90 transition-opacity disabled:opacity-50 cursor-pointer shadow-lg shadow-[#fd409a]/20',
    secondaryButton: 'bg-white/10 border border-white/10 text-white font-semibold rounded-lg sm:rounded-xl px-5 sm:px-6 py-2.5 sm:py-3 text-sm sm:text-base hover:bg-white/20 transition-all cursor-pointer',
    ghostButton: 'text-white/60 hover:text-white transition-colors cursor-pointer',
    ...
    resumeCard: 'bg-[#0d0a14] border border-white/10 rounded-xl p-4 hover:border-white/20 transition-colors',
